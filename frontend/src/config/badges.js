...
export const BADGES = [
  { id: 'account-created',    name: 'Welcome!',      description: 'Welcome aboard! We can\'t wait to see the impact you\'ll make in the open source community.', image: '/tomato_1.png', threshold: 0   },
  { id: 'first-contribution', name: 'First Commit',  description: 'Made your first AI-powered open source contribution.',      image: '/tomato_2.png', threshold: 1   },
  { id: 'streak-3',           name: 'On a Roll',     description: 'Reached 3 contributions — the momentum is building.',       image: '/tomato_3.png', threshold: 3   },
  { id: 'five-club',          name: 'Five-Club',     description: 'Five contributions and counting. You mean business.',       image: '/tomato_4.png', threshold: 5   },
  { id: 'double-digits',      name: 'Double Digits', description: 'Hit 10 contributions. Your agents are on fire.',            image: '/tomato_5.png', threshold: 10  },
